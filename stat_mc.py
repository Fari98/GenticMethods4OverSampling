...
def main():
    ...
    #'schizo','allbp', 'ann-thyroid', 'car-evaluation', 'page-blocks',

    for data_file in tqdm([  'calendarDOW', 'car', 'cars', 'collins',
                            'glass',  'soybean']):
